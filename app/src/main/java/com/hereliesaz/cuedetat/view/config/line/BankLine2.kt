...
/**
 * Configuration for the second segment of a Bank Shot path.
 */
data class BankLine2(
    ...
    /** Glow color (BankLine2Yellow with 40% alpha). */
    override val glowColor: Color = BankLine2Yellow.copy(alpha = 0.4f),
    /** Stroke width. */
    override val strokeWidth: Float = 2f,
    /** Stroke color (BankLine2Yellow). */
