...
export const initialState = {
  ...
  isSpinControlVisible: false, // New
  ...
  // UI Controls State
  zoomFactor: 1.0,
  spinControlCenter: { x: 120, y: window.innerHeight * 0.75 }, // New
  selectedSpinOffset: null, // New
  lingeringSpinOffset: null, // New

  // Interaction State
  interactionMode: 'NONE', // NONE, ROTATING_PROTRACTOR, MOVING_TARGET, MOVING_CUE, AIMING_BANK_SHOT, MOVING_BANKING_BALL, MOVING_SPIN_CONTROL
  isDragging: false,
};

// Helper function to reset positions based on context
  ...
  switch (action.type) {
    case 'SET_VIEW_SIZE': {
      const newState = {
          ...
          spinControlCenter: { x: 120, y: action.payload.height * 0.75 } // Update spin control on resize
      };
    ...
    case 'CLEAR_SPIN_STATE':
        return { ...state, lingeringSpinOffset: null };
